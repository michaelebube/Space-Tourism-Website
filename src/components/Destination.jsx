...
const Destination = ({isSidebarOpen, toggleSidebar}) => {
  ...
  return (
   ...
   <div className="relative w-screen h-screen">
     ...
     <div
    className="absolute inset-0 bg-cover bg-center bg-no-repeat xs:block md:hidden"
    ...
    <div className="flex flex-col pl-[25%] gap-2 mt-7 sm:mt-[22px] transition-transform duration-500 ease-in-out transform translate-x-5">
      ...
      <div className="flex flex-col transition-transform duration-500 ease-in-out transform translate-x-5 -ml-[15%] sm:-ml-[24%] mt-2 sm:mt-1">
        ...
        <div className=" sm:flex gap-[68px]  mt-6 sm:mt-[12px] pl-12 sm:pl-32 lg:pl-24 xl:pl-[250px] md:pl-28">
          ...
          <div>
            <h4 className="text-secColor/50 mt-6 sm:mt-0 text-xl sm:text-[13px] lg:text-[12px] md:text-[10px] xl:text-sm mb-1 sm:-mb-1">EST. TRAVEL TIME</h4>
            <h3 className="text-white text-2xl sm:text-lg ml-7 sm:ml-1  md:text-[16px] lg:text-xl xl:text-2xl">{selectedResource.travelTime}</h3>
          </div>
        </div>
      </div>
    </div>
        ...
        <Navbar_Home isSidebarOpen={isSidebarOpen} toggleSidebar={toggleSidebar} />
            ...
            <div className='flex flex-col pl-[30%] gap-2 mt-[22px] transition-transform duration-500 ease-in-out transform translate-x-5  '>
              ...
              <div className='flex flex-col transition-transform duration-500 ease-in-out transform translate-x-5 -ml-[14%] '>
                ...
                <div className='flex gap-[68px] mt-5 xl:mt-4 lg:pl-24 xl:pl-[250px] md:pl-28 '>
                    <div>
