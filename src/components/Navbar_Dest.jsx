...
const Navbar_Dest = ({ selectedResource, handleClick }) => {
  return (
    <>
      <div className=' xs:flex -ml-[3%]  justify-center lg:ml-1 xl:ml-2 md:justify-normal  md:pl-24 xl:pl-[250px] sm:h-[80px] md:h-[90px] lg:h-[20px] sm:w-[700px] md:w-[750px] lg:w-[100px] font-barlow font-semibold bg-transparent xs:text-lg sm:text-[20px] lg:text-lg xl:text-[26px] text-secColor/50'>
